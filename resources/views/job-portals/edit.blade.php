        ...
        <div class="w-full lg:max-w-screen-2xl max-h-[600px] rounded-lg shadow-md relative min-h-screen p-7 align-middle">
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit job post</h2>
                    <form action="{{ route('job-portals.update', $jobPost->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                ...
                                <input
                                    ...
                                    type="text" name="title" id="title" value="{{ $jobPost->title }}"
                            ...
                            <div class="w-full">
                                ...
                                <input
                                    ...
                                    type="number" name="salary" id="salary" value="{{ $jobPost->salary }}"
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    <option value="Full Time" {{ $jobPost->type === 'Full Time' ? 'selected' : '' }}>
                                        Full Time
                                    </option>
                                    <option value="Part Time" {{ $jobPost->type === 'Part Time' ? 'selected' : '' }}>
                                        Part Time
                                    </option>
                                </select>
                            </div>
                            <div class="w-full">
                                ...
                                <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="text" name="location" id="location" value="{{ $jobPost->location }}"
                            ...
                            <div class="w-full">
                                ...
                                <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="text" name="company" id="company" value="{{ $jobPost->company }}"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea
                                    ...
                                    id="description" rows="8" name="description" placeholder="Your description here">{{ $jobPost->description }}</textarea>
                            </div>
                        </div>
                        <button
